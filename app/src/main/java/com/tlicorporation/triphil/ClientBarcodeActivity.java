...
public class ClientBarcodeActivity extends AppCompatActivity implements BarcodeReader.BarcodeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeReader = MainActivity1.getBarcodeObject();
        ...
        // get initial list
        barcodeList = (ListView) findViewById(R.id.listViewData);
    }
