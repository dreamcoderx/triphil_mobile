...
public final class DialogBinding implements ViewBinding {
  ...
  private DialogBinding(@NonNull NestedScrollView rootView,
      @NonNull AppCompatButton appCompatButtonRegister, @NonNull NestedScrollView nestedScrollView,
      @NonNull TextInputEditText textInputEditName,
  ...
  public static DialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogBinding((NestedScrollView) rootView, appCompatButtonRegister,
          nestedScrollView, textInputEditName, textInputEditTextConfirmPassword,
          textInputEditTextEmail, textInputEditTextPassword, textInputLayoutConfirmPassword,
